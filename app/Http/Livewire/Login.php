    ...
    public function authenticate(): ?LoginResponse
    {
        ...
        try {
            ...
            Notification::make()
                ...
                ->body('As an admin, you now have access to view Cellulant Responses, Donation Requests, VCRUN Registration, and VCRUN Supporter Information. <br>
            ...
            <li>To navigate the system efficiently, use the sidebar on the left to access the dashboard. You can also collapse it to view content more comfortably.</li><br>
            ...
            <li>We hope you find the Strathmore University Foundation admin panel useful and easy to use. Enjoy using the panel, and if you have any questions or concerns, please don\'t hesitate to contact our support team.</li><br>
                 </ol>
                 ')
                ->success()
                ->persistent()
